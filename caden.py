...
def inference_score(path, filename: str):
    ...
    mid = MidiFile(f"music-player/public/output/{filename}.mid")
    ...
    for track in mid.tracks:
        ...
        for msg in track:
            ...
            if msg.type == 'note_off':
                ...
                rendered = signal_generator.to_audio_segment(duration=duration - 50, volume=-20).fade_out(10).fade_in(
                    30)

                output = output.overlay(rendered, start_pos)

    output.export(f"music-player/public/output/{filename}.wav", format="wav")
